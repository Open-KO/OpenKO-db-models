# OpenKO-db-models
OpenKO-db-models is a C++ library of models for the OpenKO database, for use in OpenKO projects.  It is largely generated by the jsonSchema in the OpenKO-db 
...
You can view the Doxygen output here: [OpenKO Database Model Documentation](https://open-ko.github.io/OpenKO-db-models).
